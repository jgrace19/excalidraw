...
Click **Fork** (top right) of this page. Fork into your own GitHub account — your workshop changes will live on a branch in your fork, and you'll open a pull request back to `jgrace19/excalidraw` at the end.
...
Open a new terminal, navigate to a directory that you can clone this repository into.
Clone the repo with the command below. Replace `<your-handle>` with your GitHub username:
